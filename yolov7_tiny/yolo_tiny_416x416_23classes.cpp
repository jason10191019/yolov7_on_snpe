...
std::unique_ptr<zdl::SNPE::SNPE> initializeSNPE(zdl::DlSystem::Runtime_t runtime) {
    ...
    container = zdl::DlContainer::IDlContainer::open("/root/models/yolo_tiny_416x416_23classes.dlc");   
...
int main() {
    //class 
    std::vector<std::string> class_names = {"person", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "traffic light",
    ...
    //load_pic
    std::string image_path = "/root/models/789.jpg";
